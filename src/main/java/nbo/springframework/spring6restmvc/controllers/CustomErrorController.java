...
public class CustomErrorController {
    ...
    ResponseEntity handleJPAViolationException(TransactionSystemException transactionSystemException){
        ...
        if (transactionSystemException.getCause().getCause() instanceof ConstraintViolationException){
            ConstraintViolationException cex = (ConstraintViolationException) transactionSystemException.getCause().getCause();

            List errors = cex.getConstraintViolations().stream()
